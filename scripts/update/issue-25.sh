...
# Link module
ln -s $ZENCI_DEPLOY_DIR/modules/advanced_sphinx $SITEPATH/sites/all/modules/local/
...
#import variables
drush ddi variables --file=$ZENCI_DEPLOY_DIR/data/advanced_sphinx.variables.export
...
cp  $ZENCI_DEPLOY_DIR/data/sphinx.conf ~/sphinx/
...
drush ddi blocks --file=$ZENCI_DEPLOY_DIR/data/alpha.blocks.export
