 ...
 * @version    CVS: $Id: Interwiki.php,v 1.1 2007/02/23 01:44:17 roetzi Exp $
...
//            $page = $this->urlEncode($options['page']);
            // no encoding in url for slashes
            $parts = array();
            foreach(explode('/', $options['page']) as $part) {
              $parts[] = $this->urlEncode($part);
            }
            $page = implode('/', $parts);
