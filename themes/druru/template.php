 ...
 * @see _druru_theme()
 */
function druru_theme(&$existing, $type, $theme, $path) {
  druru_include($theme, 'theme/registry.inc');
  return _druru_theme($existing, $type, $theme, $path);
}
 ...
 */
druru_include('druru', 'theme/alter.inc');
