...
<div class="forum-sort">
  <?php print isset($sort_header) ? render($sort_header) : ''; ?></div>
<div id="forum-topic-<?php print $topic_id; ?>" class="clearfix forum-topic-list">
  <?php if (empty($topics)): ?>
    <div class="alert alert-block alert-info">
      <i class="fa fa-info-circle"></i>
      <?php print t('There are no topics.'); ?>
    </div>
  <?php else: ?>
      ...
      <div class="row <?php print $topic->zebra; ?>">
        ...
        <?php else: ?>
          ...
          <div class="replies col-xs-3 col-sm-2 col-md-2">
            <?php print druru_icon('comment-o', NULL, array(
              'class' => array('small'),
            )); ?>
            ...
            <?php if ($topic->new_replies): ?>
              <span class="new_replies">
                <a href="<?php print $topic->new_url; ?>">
                  <?php print druru_icon('comment'); ?>
                  <?php print $topic->new_replies; ?>
                </a>
              </span>
            <?php endif; ?>
          </div>
