...
function alpha_preprocess_node(&$variables){
  ...
  if(!$variables['teaser']){
    drupal_add_js('(function($){ $("#node-details").affix({offset: {top: function (){ $("#node-details").width($("#node-details").parent().width()); return: 100;}}}); })(jQuery);', array('type' => 'inline', 'scope' => 'footer'));
  }
}
